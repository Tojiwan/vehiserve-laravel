                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="stat-card-icon bg-green-100 text-green-600">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 10h10a1 1 0 011 1v10a1 1 0 01-1 1h-3m-6 0a1 1 0 100 2h3m-3 0a1 1 0 100 2H7"></path>
                        </svg>
                    </div>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($trip['return_date'])->format('M d, Y') }}</td>
                            <td>
                                <span class="badge 
