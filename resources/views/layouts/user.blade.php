    ...
    <aside class="sidebar" x-bind:class="{ 'collapsed': collapsed }" x-bind:class="{ 'lg:translate-x-0': !collapsed, '-translate-x-full': collapsed }">
        <div class="flex flex-col h-full">
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('user.trip-request.create') }}" class="sidebar-link {{ request()->routeIs('user.trip-request.create') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    <span class="sidebar-label">New Trip Request</span>
                </a>
