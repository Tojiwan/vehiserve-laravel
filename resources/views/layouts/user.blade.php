...
<head>
    ...
    <title>{{ config('app.name', 'Vehiserve') }} - User Portal</title>
    ...
    <header class="header">
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('user.dashboard') }}" class="flex items-center gap-2">
                ...
                <span class="text-xl font-bold text-red-700">VEHISERVE</span>
            </a>
        </div>
    ...
    <aside class="sidebar" x-bind:class="{ 'collapsed': collapsed }" x-bind:class="{ 'lg:translate-x-0': !collapsed, '-translate-x-full': collapsed }">
        <div class="flex flex-col h-full">
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('user.vehicle-request.create') }}" class="sidebar-link {{ request()->routeIs('user.vehicle-request.create') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                    </svg>
                    <span class="sidebar-label">New Vehicle Request</span>
                </a>

                <a href="{{ route('user.travel-request.create') }}" class="sidebar-link {{ request()->routeIs('user.travel-request.create') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    <span class="sidebar-label">New Travel Request</span>
                </a>

                <a href="{{ route('user.document-tracking') }}" class="sidebar-link {{ request()->routeIs('user.document-tracking') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                    </svg>
                    <span class="sidebar-label">Document Tracking</span>
                </a>

                <a href="{{ route('user.documents') }}" class="sidebar-link {{ request()->routeIs('user.documents') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
